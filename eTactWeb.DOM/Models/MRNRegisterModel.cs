...
namespace eTactWeb.DOM.Models
{
    public class MRNRegisterModel
    {
        ...
        public IList<MRNRegisterDetail>? MRNRegisterDetail { get; set; }
        //public IList<GateEntryRegisterDetail>? GateEntryRegisterDetail { get; set; }
    }
    public class MRNRegisterDetail
    {
        ...
        public string? AcceptedStore { get; set; }

        public decimal? AltAcceptedQty { get; set; }
        public decimal? RejectedQty { get; set; }
        public string? RejectedStore { get; set; }

        public decimal? HoldQty { get; set; }
        public decimal? Reworkqty { get; set; }
        public string? ReworkStore { get; set; }
