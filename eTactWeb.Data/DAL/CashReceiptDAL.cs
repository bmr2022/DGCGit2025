...
namespace eTactWeb.Data.DAL
{
    public class CashReceiptDAL
    {
        ...
        public CashReceiptDAL(IConfiguration configuration, IDataLogic iDataLogic, ConnectionStringService connectionStringService, ICommon common)
        {
        ...
        public async Task<ResponseResult> GetFormRights(int userId)
        {
            ...
            try
            {
                ...
                SqlParams.Add(new SqlParameter("@MainMenu", "Cash Receipt"));
