...
namespace eTactWeb.Data.DAL
{
    public class StockRegisterDAL
    {
        ...
        public StockRegisterDAL(IConfiguration configuration, IDataLogic iDataLogic, IHttpContextAccessor httpContextAccessor, ConnectionStringService connectionStringService, ICommon common)
        {
            ...
            var parameters = new Dictionary<string, object>
    {
        ...
        { "@GroupName",ItemGroup == null ? "" : ItemGroup },
        { "@CatName",ItemType == null ? "" : ItemType },
        { "@Storeid", StoreId },
        
        {"@BatchNo", BatchNo == null ? "" : BatchNo },
        { "@Uniquebatchno", UniqueBatchNo == null ? "" : UniqueBatchNo },
