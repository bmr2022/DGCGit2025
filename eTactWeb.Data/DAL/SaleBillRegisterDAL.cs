...
namespace eTactWeb.Data.DAL
{
    public class SaleBillRegisterDAL
    {
        ...
        public SaleBillRegisterDAL(IConfiguration configuration, IDataLogic iDataLogic, IHttpContextAccessor httpContextAccessor, ConnectionStringService connectionStringService, ICommon common)
        {
            ...
            var parameters = new Dictionary<string, object>
    {
        ...
        { "@yearcode", yearcode },
        { "@ItemParentGroup", ItemParentGroup },
        ...
        public async Task<ResponseResult> FillCustomerList(string FromDate, string ToDate, string SearchText)
        {
            var fromDt = CommonFunc.ParseFormattedDate(FromDate);
            var toDt = CommonFunc.ParseFormattedDate(ToDate);
            var _ResponseResult = new ResponseResult();
            try
            {
                ...
                SqlParams.Add(new SqlParameter("@Customername", SearchText));
                _ResponseResult = await _IDataLogic.ExecuteDataSet("SPReportSalebillRegister", SqlParams);
            }
            catch (Exception ex)
            {
                dynamic Error = new ExpandoObject();
        ...
        public async Task<ResponseResult> FillItemGroupList(string FromDate, string ToDate, string SearchText)
        {
            var fromDt = CommonFunc.ParseFormattedDate(FromDate);
            var toDt = CommonFunc.ParseFormattedDate(ToDate);
            var _ResponseResult = new ResponseResult();
            ...
            {
                var SqlParams = new List<dynamic>();
                SqlParams.Add(new SqlParameter("@Flag", "FillItemGroupList"));
                SqlParams.Add(new SqlParameter("@fromdate", fromDt));
                SqlParams.Add(new SqlParameter("@todate", toDt));
                SqlParams.Add(new SqlParameter("@Customername", SearchText));
                _ResponseResult = await _IDataLogic.ExecuteDataSet("SPReportSalebillRegister", SqlParams);
        ...
        public async Task<ResponseResult> FillSaleBillList(string FromDate, string ToDate, string SearchText)
        {
            var fromDt = CommonFunc.ParseFormattedDate(FromDate);
            var toDt = CommonFunc.ParseFormattedDate(ToDate);
            var _ResponseResult = new ResponseResult();
            try
            {
                ...
                SqlParams.Add(new SqlParameter("@fromdate", fromDt));
                SqlParams.Add(new SqlParameter("@todate", toDt));
                SqlParams.Add(new SqlParameter("@InvNo", SearchText));
                _ResponseResult = await _IDataLogic.ExecuteDataSet("SPReportSalebillRegister", SqlParams);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ResponseResult> FillSONO(string FromDate, string ToDate, string SearchText)
        {
            var fromDt = CommonFunc.ParseFormattedDate(FromDate);
            var toDt = CommonFunc.ParseFormattedDate(ToDate);
            var _ResponseResult = new ResponseResult();
            try
            {
                ...
                SqlParams.Add(new SqlParameter("@fromdate", fromDt));
                SqlParams.Add(new SqlParameter("@todate", toDt));
                SqlParams.Add(new SqlParameter("@SONo", SearchText));
                _ResponseResult = await _IDataLogic.ExecuteDataSet("SPReportSalebillRegister", SqlParams);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ResponseResult> FillSchNo(string FromDate, string ToDate, string SearchText)
        {
            var fromDt = CommonFunc.ParseFormattedDate(FromDate);
            var toDt = CommonFunc.ParseFormattedDate(ToDate);
            var _ResponseResult = new ResponseResult();
            try
            {
                ...
                SqlParams.Add(new SqlParameter("@fromdate", fromDt));
                SqlParams.Add(new SqlParameter("@todate", toDt));
                SqlParams.Add(new SqlParameter("@SchNo", SearchText));
                _ResponseResult = await _IDataLogic.ExecuteDataSet("SPReportSalebillRegister", SqlParams);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ResponseResult> FillHSNNo(string FromDate, string ToDate, string SearchText)
        {
            var fromDt = CommonFunc.ParseFormattedDate(FromDate);
            var toDt = CommonFunc.ParseFormattedDate(ToDate);
            var _ResponseResult = new ResponseResult();
            try
            {
                ...
                SqlParams.Add(new SqlParameter("@fromdate", fromDt));
                SqlParams.Add(new SqlParameter("@todate", toDt));
                SqlParams.Add(new SqlParameter("@HSNNO", SearchText));
                _ResponseResult = await _IDataLogic.ExecuteDataSet("SPReportSalebillRegister", SqlParams);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ResponseResult> FillGSTNo(string FromDate, string ToDate, string SearchText)
        {
            var fromDt = CommonFunc.ParseFormattedDate(FromDate);
            var toDt = CommonFunc.ParseFormattedDate(ToDate);
            var _ResponseResult = new ResponseResult();
            try
            {
                ...
                SqlParams.Add(new SqlParameter("@fromdate", fromDt));
                SqlParams.Add(new SqlParameter("@todate", toDt));
                SqlParams.Add(new SqlParameter("@GSTNo", SearchText));
                _ResponseResult = await _IDataLogic.ExecuteDataSet("SPReportSalebillRegister", SqlParams);
            }
            catch (Exception ex)
            {
