...
namespace eTactWeb.Data.DAL
{
    public class StockValuationDAL
    {
        ...
        public StockValuationDAL(IConfiguration configuration, IDataLogic iDataLogic, ConnectionStringService connectionStringService)
        {
                    ...
                    if (oDataSet.Tables.Count > 0 && oDataSet.Tables[0].Rows.Count > 0)
                    {
                        resultList.StockValuationGrid = (from DataRow row in oDataSet.Tables[0].Rows
                                                         select new StockValuationModel
                                                         {
                                                             ...
                                                             OpeningStock = row["OpeningStock"] == DBNull.Value ? 0 : Convert.ToSingle(row["OpeningStock"]),
                                                             OpenRate = row["OpenRate"] == DBNull.Value ? 0 : Convert.ToSingle(row["OpenRate"]),
                                                             OpeningValue = row["OpeningValue"] == DBNull.Value ? 0 : Convert.ToSingle(row["OpeningValue"]),
                                                             RecQty = row["RecQty"] == DBNull.Value ? 0 : Convert.ToSingle(row["RecQty"]),
                                                             IssueQty = row["IssueQty"] == DBNull.Value ? 0 : Convert.ToSingle(row["IssueQty"]),
                                                             ClosingStock = row["ClosingStock"] == DBNull.Value ? 0 : Convert.ToSingle(row["ClosingStock"]),
                                                             Rate = row["Rate"] == DBNull.Value ? 0 : Convert.ToSingle(row["Rate"]),
                                                             ClosingValue = row["ClosingValue"] == DBNull.Value ? 0 : Convert.ToSingle(row["ClosingValue"]),
