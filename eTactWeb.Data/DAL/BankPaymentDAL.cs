...
namespace eTactWeb.Data.DAL
{
    public class BankPaymentDAL
    {
        ...
        public BankPaymentDAL(IConfiguration configuration, IDataLogic iDataLogic, ConnectionStringService connectionStringService, ICommon common)
        {
        ...
        public async Task<ResponseResult> GetFormRights(int userId)
        {
            ...
            try
            {
                ...
                SqlParams.Add(new SqlParameter("@MainMenu", "Bank Payment"));
