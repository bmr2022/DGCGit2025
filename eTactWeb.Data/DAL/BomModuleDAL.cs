    ...
    : (DateTime?)null;
                            ...
                            model.BomList = (from DataRow dr in oDataTable.Rows
                                             select new BomModel
                                             {
                                                 ...
                                                 AltItemCode2 = Convert.ToInt32(dr["AltItemCode2"]),
                                                 ...
                                                 Scrap = Convert.ToDecimal(dr["Scrap"]),
                                                 RunnerItemCode = Convert.ToInt32(dr["RunnerItemCode"]),
                                                 RunnerQty = Convert.ToDecimal(dr["RunnerQty"]),
