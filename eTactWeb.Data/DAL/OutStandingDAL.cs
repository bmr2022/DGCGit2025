    ...
    int Slab2, int Slab3, int Slab4, int Slab5, int Slab6, string ShowOnlyApprovedBill, bool ShowZeroBal, string VoucherNo, string VoucherType)
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(DBConnectionString))
                {
                    ...
                    command.Parameters.AddWithValue("@GroupCode", GroupName);
                    command.Parameters.AddWithValue("@AccountNamwList", accountNameCsv);
                    command.Parameters.AddWithValue("@ACCOUNTCODE", AccountCode);
                    command.Parameters.AddWithValue("@DaysforSlot", DaysforSlot);
                    command.Parameters.AddWithValue("@startSlab1", Slab1);
                    command.Parameters.AddWithValue("@Slab2", Slab2);
                    command.Parameters.AddWithValue("@Slab3", Slab3);
                    command.Parameters.AddWithValue("@Slab4", Slab4);
                    command.Parameters.AddWithValue("@Slab5", Slab5);
                    command.Parameters.AddWithValue("@Slab6", Slab6);
