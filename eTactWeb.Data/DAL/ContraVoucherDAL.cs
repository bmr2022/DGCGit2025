...
namespace eTactWeb.Data.DAL
{
    ...
    public class ContraVoucherDAL
    {
        ...
        public ContraVoucherDAL(IConfiguration configuration, IDataLogic iDataLogic, ConnectionStringService connectionStringService, ICommon common)
        {
        ...
        public async Task<ResponseResult> GetFormRights(int userId)
        {
            ...
            try
            {
                ...
                SqlParams.Add(new SqlParameter("@MainMenu", "ContraVoucher"));
        ...
        public async Task<ResponseResult> FillLedgerName(string VoucherType, string Type)
        {
            ...
            try
            {
                ...
                SqlParams.Add(new SqlParameter("@VoucherType", "CONTRA-VOUCHER"));
        ...
        public async Task<ResponseResult> FillModeofAdjust(string VoucherType)
        {
            ...
            try
            {
                ...
                SqlParams.Add(new SqlParameter("@VoucherType", "Contra"));
                _ResponseResult = await _IDataLogic.ExecuteDataTable("AccSpVoucherEntry", SqlParams);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ResponseResult> SaveContraVoucher(ContraVoucherModel model, DataTable GIGrid)
        {
            ...
            try
            {
                ...
                sqlParams.Add(new SqlParameter("@Subvoucher", "CONTRA-VOUCHER"));
            ...
            var parameters = new Dictionary<string, object>
    {
     ...
     //   {"@Flag", "DASHBOARD" },
        ...
        public async Task<ContraVoucherModel> GetDashBoardDetailData(string FromDate, string ToDate, string LedgerName, string Bank, string VoucherNo)
        {
            ...
            try
            {
                using (SqlConnection myConnection = new SqlConnection(DBConnectionString))
                {
                    ...
                    oCmd.Parameters.AddWithValue("@VoucherType", "CONTRA-VOUCHER");
                ...
                {
                    model.ContraVoucherGrid = (from DataRow dr in oDataSet.Tables[0].Rows
                                               select new ContraVoucherModel
                                               {
                                                   ...
                                                   Ins = dr["instrument"] != DBNull.Value ? dr["instrument"].ToString() : string.Empty,
                                                   InsNo = dr["instrumentNo"] != DBNull.Value ? dr["instrumentNo"].ToString() : string.Empty,
                                                   InsDate = dr["InstrumentDate"] != DBNull.Value ? dr["InstrumentDate"].ToString() : string.Empty,
                                                   ChequeDate = dr["ChequeDate"] != DBNull.Value ? dr["ChequeDate"].ToString() : string.Empty,
                                                   ChequeClearDate = dr["ChequeClearDate"] != DBNull.Value ? dr["ChequeClearDate"].ToString() : string.Empty,
                                                   ...
                                                   SONo = dr["SONo"] != DBNull.Value ? Convert.ToInt32(dr["SONo"]) : 0,
                                                   SOYear = dr["SOYear"] != DBNull.Value ? Convert.ToInt32(dr["SOYear"]) : 0,
                                                   SoDate = dr["SoDate"] != DBNull.Value ? dr["SoDate"].ToString() : string.Empty,
        ...
        private static ContraVoucherModel PrepareView(DataSet DS, ref ContraVoucherModel? model)
        {
            var ItemList = new List<ContraVoucherModel>();
            ...
            model.VoucherDate = DS.Tables[0].Rows[0]["VoucherDocdate"].ToString().Split(" ")[0];
            ...
            if (DS.Tables.Count != 0 && DS.Tables[1].Rows.Count > 0)
            {
                ...
                {
                    ItemList.Add(new ContraVoucherModel
                    {
                ...
                model.ContraVoucherGrid = ItemList.OrderBy(x => x.SrNO).ToList();
            }
        ...
        public async Task<ResponseResult> GetSODate(int SONO, string accountcode, string VoucherDate, string SOYearCode)
        {
            ...
            try
            {
                ...
                SqlParams.Add(new SqlParameter("@VoucherType", "CONTRA-VOUCHERt"));
                SqlParams.Add(new SqlParameter("@ModOfAdjutment", "Advance"));
                SqlParams.Add(new SqlParameter("@accountcode", accountcode));
                SqlParams.Add(new SqlParameter("@VoucherDate", voucherDt));
        ...
        public async Task<ResponseResult> FillAgainstBillNoInDashboard(string FromDate, string ToDate, string VoucherType)
        {
            ...
            {
                var SqlParams = new List<dynamic>();
                SqlParams.Add(new SqlParameter("@Flag", "FillAgainstBillNoInDashboard"));
                SqlParams.Add(new SqlParameter("@fromdate", ParseFormattedDate(FromDate)));
                SqlParams.Add(new SqlParameter("@todate", ParseFormattedDate(ToDate)));
                SqlParams.Add(new SqlParameter("@VoucherType", "CONTRA-VOUCHER"));
                _ResponseResult = await _IDataLogic.ExecuteDataTable("AccSpVoucherEntry", SqlParams);
        ...
        public async Task<ResponseResult> FillSoNoInDashboard(string FromDate, string ToDate, string VoucherType)
        {
            ...
            {
                var SqlParams = new List<dynamic>();
                SqlParams.Add(new SqlParameter("@Flag", "FillSoNoInDashboard"));
                SqlParams.Add(new SqlParameter("@fromdate", ParseFormattedDate(FromDate)));
                SqlParams.Add(new SqlParameter("@todate", ParseFormattedDate(ToDate)));
                SqlParams.Add(new SqlParameter("@VoucherType", "CONTRA-VOUCHER"));
                _ResponseResult = await _IDataLogic.ExecuteDataTable("AccSpVoucherEntry", SqlParams);
