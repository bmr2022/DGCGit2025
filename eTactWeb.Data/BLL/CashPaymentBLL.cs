...
namespace eTactWeb.Data.BLL
{
    public class CashPaymentBLL : ICashPayment
    {
        ...
        public CashPaymentBLL(IConfiguration config, IDataLogic dataLogicDAL)
        {
            _CashPaymentDAL = new CashPaymentDAL(config, dataLogicDAL);
        ...
        {
            return await _CashPaymentDAL.FillEntryID(YearCode);
        }
