...
namespace eTactWeb.Data.BLL
{
    public class AccGroupLedgerBLL:IAccGroupLedger
    {
        ...
        public AccGroupLedgerBLL(IConfiguration config, IDataLogic dataLogicDAL, ConnectionStringService connectionStringService)
        {
            _AccGroupLedgerDAL = new AccGroupLedgerDAL(config, dataLogicDAL, connectionStringService);
