...
namespace eTactWeb.Data.BLL
{
    public class BOMReportBLL:IBOMReport
    {
        ...
        public BOMReportBLL(IConfiguration config, IDataLogic dataLogicDAL, ConnectionStringService connectionStringService)
        {
            _BOMReportDAL = new BOMReportDAL(config, dataLogicDAL, connectionStringService);
        ...
        {
            return await _BOMReportDAL.GetBomTreeDetailsData( fromDate,toDate, Yearcode, ReportType, FGPartCode, RMPartCode, Storeid, calculateQty, FGItemCode);
        }
    }
}
