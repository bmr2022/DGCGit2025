...
namespace eTactWeb.Data.BLL
{
    ...
    {
        private CloseProductionPlanDAL _CloseProductionPlanDAL;
        private readonly IDataLogic _DataLogicDAL;

        public CloseProductionPlanBLL(IConfiguration config, IDataLogic dataLogicDAL, ConnectionStringService connectionStringService)
        {
            _CloseProductionPlanDAL = new CloseProductionPlanDAL(config, dataLogicDAL, connectionStringService);
