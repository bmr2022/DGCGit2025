...
namespace eTactWeb.Data.BLL
{
    public class CashReceiptBLL : ICashReceipt
    {
        ...
        public CashReceiptBLL(IConfiguration config, IDataLogic dataLogicDAL, ConnectionStringService connectionStringService)
        {
            _CashReceiptDAL = new CashReceiptDAL(config, dataLogicDAL, connectionStringService);
        ...
        {
            return await _CashReceiptDAL.GetDashBoardDetailData(FromDate, ToDate, LedgerName, VoucherNo, AgainstVoucherRefNo, AgainstVoucherNo);
        }
        ...
        {
            return await _CashReceiptDAL.GetDashBoardSummaryData(FromDate, ToDate, LedgerName, VoucherNo, AgainstVoucherRefNo, AgainstVoucherNo);
        }
        ...
        {
            return await _CashReceiptDAL.GetSODetail(SONO, accountcode, VoucherDate);
        }
