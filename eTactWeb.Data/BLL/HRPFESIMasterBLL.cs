...
namespace eTactWeb.Data.BLL
{
    public class HRPFESIMasterBLL: IHRPFESIMaster
    {
        ...
        public HRPFESIMasterBLL(IConfiguration config, IDataLogic dataLogicDAL, ConnectionStringService connectionStringService)
        {
            //configuration = config;
            _HRPFESIMasterDAL = new HRPFESIMasterDAL(config, dataLogicDAL, connectionStringService);
