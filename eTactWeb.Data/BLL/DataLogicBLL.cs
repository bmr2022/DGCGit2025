...
{  
    ...
    {
        return await _DataLogicDAL.GetDbCrDataGrid(DbCrGridd, TaxDetailDT, TDSDetailDT, FormName, docAccountCode, AccountCode, ItemNetAmount, NetTotal, RoundOffAccountCode, RoundOffAmount,   CashDis,   AdditionalDis);
    }
