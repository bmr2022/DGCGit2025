...
namespace eTactWeb.Data.BLL
{
    public class TransferMaterialReportBLL : ITransferMaterialReport
    {
        ...
        public TransferMaterialReportBLL(IConfiguration configuration, IDataLogic iDataLogic)
        {
            _DataLogicDAL = iDataLogic;
            _TransferMaterialReportDAL = new TransferMaterialReportDAL(configuration, iDataLogic, _httpContextAccessor);
        }
