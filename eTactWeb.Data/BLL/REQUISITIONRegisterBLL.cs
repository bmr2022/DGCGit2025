...
namespace eTactWeb.Data.BLL
{
    public class REQUISITIONRegisterBLL : IREQUISITIONRegister
    {
        ...
        public REQUISITIONRegisterBLL(IConfiguration configuration, IDataLogic iDataLogic)
        {
            _DataLogicDAL = iDataLogic;
            _REQUISITIONRegisterDAL = new REQUISITIONRegisterDAL(configuration, iDataLogic, _httpContextAccessor);
        }
