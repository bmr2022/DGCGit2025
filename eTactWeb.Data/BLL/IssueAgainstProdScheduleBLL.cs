...
namespace eTactWeb.Data.BLL
{
    public class IssueAgainstProdScheduleBLL : IIssueAgainstProdSchedule
    {
        ...
        public IssueAgainstProdScheduleBLL(IConfiguration configuration, IDataLogic iDataLogic, ConnectionStringService connectionStringService)
        {
            _DataLogicDAL = iDataLogic;
            _IssueAgainstProdScheduleDAL = new IssueAgainstProdScheduleDAL(configuration, iDataLogic, connectionStringService);
        }
