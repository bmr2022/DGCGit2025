...
namespace eTactWeb.Data.BLL
{
    public class DashboardBLL : IDashboard
    {
        ...
        {
            return await _DashboardDAL.FillPurchaseDashboardNewVendorInThisMonthData();
        }
        ...
        {
            return await _DashboardDAL.SavePOMonthlyTrend();
        }
        public async Task<ResponseResult> SavePOCategoryWise()
        {
            return await _DashboardDAL.SavePOCategoryWise();
        }
        public async Task<ResponseResult> SavePOVsConsumption()
        {
            return await _DashboardDAL.SavePOVsConsumption();
        }
        ...
        {
            return await _DashboardDAL.FillSALEMonthlyTrend();
        }
        ...
        {
            return await _DashboardDAL.FillNEWCustomerOFTHEMONTH();
        }
        public async Task<ResponseResult> FillMonthlyRejectionTrend()
        {
            return await _DashboardDAL.FillMonthlyRejectionTrend();
        }
        public async Task<ResponseResult> FillSaleOrderVsDispatch()
        {
            return await _DashboardDAL.FillSaleOrderVsDispatch();
        }
