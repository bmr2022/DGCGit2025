...
namespace eTactWeb.Data.BLL
{
    public class SSApprovalBLL : ISSApproval
    {
        ...
        public SSApprovalBLL(IConfiguration configuration, IDataLogic iDataLogic, ConnectionStringService connectionStringService)
        {
            _SSAppDAL = new SSApprovalDAL(configuration, iDataLogic, connectionStringService);
