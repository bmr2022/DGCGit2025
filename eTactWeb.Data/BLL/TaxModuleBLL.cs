...
namespace eTactWeb.Data.BLL
{
    public class TaxModuleBLL : ITaxModule
    {
        ...
        public TaxModuleBLL(IConfiguration configuration, IDataLogic iDataLogic, ConnectionStringService connectionStringService)
        {
            _TaxModuleDAL = new TaxModuleDAL(configuration, iDataLogic,connectionStringService);
        }
