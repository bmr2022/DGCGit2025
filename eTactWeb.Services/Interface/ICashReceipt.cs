...
namespace eTactWeb.Services.Interface
{
    public interface ICashReceipt
    {
        ...
        Task<ResponseResult> SaveCashReceipt(CashReceiptModel model, DataTable GIGrid);
        Task<ResponseResult> GetDashBoardData(string summaryDetail, string FromDate, string ToDate, string LedgerName, string Bank, string VoucherNo, string AgainstVoucherNo, string SoNo, string AgainstBillno);

        //Task<ResponseResult> GetDashBoardData(string FromDate, string ToDate);
        Task<CashReceiptModel> GetDashBoardDetailData(string FromDate, string ToDate, string LedgerName, string Bank, string VoucherNo, string AgainstVoucherNo, string SoNo, string AgainstBillno);
        Task<CashReceiptModel> GetDashBoardSummaryData(string FromDate, string ToDate, string LedgerName, string Bank, string VoucherNo, string AgainstVoucherNo, string SoNo, string AgainstBillno);
        ...
        Task<CashReceiptModel> PopUpForPendingVouchers(PopUpDataTableAgainstRef DataTable);
        Task<CashReceiptModel> GetViewByID(int ID, int YearCode, string VoucherNo);
