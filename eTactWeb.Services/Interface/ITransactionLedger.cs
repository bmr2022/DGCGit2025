...
namespace eTactWeb.Services.Interface
{
    public interface ITransactionLedger
    {
        ...
        Task<ResponseResult> GetCompanyDetail(int? AccountCode);
        public Task<TransactionLedgerModel> GetDetailsData(string FromDate, string ToDate, string ReportType, string GroupOrLedger, int? ParentAccountCode, int? AccountCode, string VoucherType, string VoucherNo, string InvoiceNo, string Narration, float? Amount, string? DR, string? CR, string Ledger, string AccountName);
