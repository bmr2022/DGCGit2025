...
namespace eTactWeb.Data.BLL
{
    public class LedgerOpeningEntryBLL:ILedgerOpeningEntry
    {
        ...
        public async Task<ResponseResult> GetGroupByAccountCode(string LedgerName)
        {
            return await _LedgerOpeningEntryDAL.GetGroupByAccountCode(LedgerName);
        } 
        ...
        public async Task<LedgerOpeningEntryDashBoardGridModel> GetDashboardDetailData()
        {
            return await _LedgerOpeningEntryDAL.GetDashboardDetailData();
        }
