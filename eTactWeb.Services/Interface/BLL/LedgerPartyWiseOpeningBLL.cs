...
namespace eTactWeb.Data.BLL
{
    public  class LedgerPartyWiseOpeningBLL:ILedgerPartyWiseOpening
    {
        ...
        public LedgerPartyWiseOpeningBLL(IConfiguration config, IDataLogic dataLogicDAL)
        {
        ...
        public async Task<LedgerPartyWiseOpeningDashBoardModel> GetDashboardDetailData()
        {
            return await _LedgerPartyWiseOpeningDAL.GetDashboardDetailData();
