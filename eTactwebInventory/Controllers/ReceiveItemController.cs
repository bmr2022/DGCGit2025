        ...
        private static DataTable GetDetailTable(IList<ReceiveItemDetail> ReceiveItemDetail)
        {
            try
            {
                ...
                foreach (var Item in ReceiveItemDetail)
                {
                    ...
                    Item.RecMatEntryDate==null ? string.Empty : ParseFormattedDate(Item.RecMatEntryDate.Split(" ")[0]),
                    Item.RecMatYearCode== 0 ? 0 : Item.RecMatYearCode,
                    Item.RecMatSlipNo==null ? "" : Item.RecMatSlipNo,
                    Item.RecMatSlipDate == null ? string.Empty : ParseFormattedDate(Item.RecMatSlipDate.Split(" ")[0]),
                    Item.SeqNo== 0 ? 0 : Item.SeqNo,
                    Item.ReceiveDate==null ? string.Empty : ParseFormattedDate(Item.ReceiveDate.Split(" ")[0]),
                    ...
                    Item.ProdEntryDate == null ? string.Empty : ParseFormattedDate(Item.ProdEntryDate.Split(" ")[0]),
                    Item.ProdEntryId == 0 ? 0 : Item.ProdEntryId,
