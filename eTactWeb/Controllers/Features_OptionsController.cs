...
string AccPurchaseBillInvoicePrintoutFilename, string FIFOBasedBatchInventoryInJobWorkIss)
		{
			...
			{
				int ActualEntryBy = Convert.ToInt32(HttpContext.Session.GetString("UID"));
				string MachineName = HttpContext.Session.GetString("ClientMachineName");
				string IPAddress = HttpContext.Session.GetString("ClientIP");
				MainModel = await _IFeatures_Options.GetViewByID(Type, ActualEntryBy, MachineName, IPAddress).ConfigureAwait(false);
		...
		public async Task<ActionResult> FeaturesOptionsSaleOrder(int ID, int YC, string Mode, string Type)
		{
			int ActualEntryBy = Convert.ToInt32(HttpContext.Session.GetString("UID"));
			var rights = await _IFeatures_Options.GetFormRights(ActualEntryBy);
		...
		[HttpPost]
		public async Task<IActionResult> FeaturesOptionsSaleOrder(Features_OptionsModel model, string Type = "SaleOrderDetail")
		{
			try
			{
				model.CreatedBy = Convert.ToInt32(HttpContext.Session.GetString("UID"));
				...
				return RedirectToAction(nameof(FeaturesOptionsSaleOrder));
		...
		public async Task<ActionResult> FeaturesOptionsProduction(string Type, string Mode, int ID, int YC)
		{
			var MainModel = new Features_OptionsModel();
			int ActualEntryBy = Convert.ToInt32(HttpContext.Session.GetString("UID"));
			string MachineName = HttpContext.Session.GetString("ClientMachineName");
			...
			Type = "Production";
			//MainModel = await _IFeatures_Options.GetViewByID(Type,ActualEntryBy,MachineName,IPAddress).ConfigureAwait(false);
			MainModel = await _IFeatures_Options.GetViewByIDForProduction(Type, ActualEntryBy, MachineName, IPAddress).ConfigureAwait(false);
			MainModel.Mode = Mode; // Set Mode to Update


			return View(MainModel);
		}
		public async Task<ActionResult> FeaturesOptionsAccounts(string Type, string Mode, int ID, int YC)
		{
			var MainModel = new Features_OptionsModel();
			int ActualEntryBy = Convert.ToInt32(HttpContext.Session.GetString("UID"));
			string MachineName = HttpContext.Session.GetString("ClientMachineName");
			...
			Type = "Accounts";
			//MainModel = await _IFeatures_Options.GetViewByID(Type,ActualEntryBy,MachineName,IPAddress).ConfigureAwait(false);
			MainModel = await _IFeatures_Options.GetViewByIDForAccounts(Type, ActualEntryBy, MachineName, IPAddress).ConfigureAwait(false);
			MainModel.Mode = Mode; // Set Mode to Update
		...
		public async Task<IActionResult> FeaturesOptionsSaleInvoice(Features_OptionsModel model, string Type = "SaleOrderDetail")
		{
			try
			{
				...
				//var Result = await _IFeatures_Options.SaveFeatures_Options(model);
				var Result = await _IFeatures_Options.SaveFeatures_OptionsForAccounts(model);
				if (Result != null)
				{
					if (Result.StatusText == "Success" && Result.StatusCode == HttpStatusCode.OK)
					{
		...
		[HttpPost]
		public async Task<IActionResult> FeaturesOptionsProduction(Features_OptionsModel model, string Type = "Production")
		{
			try
			{
				model.CreatedBy = Convert.ToInt32(HttpContext.Session.GetString("UID"));
				...
				//var Result = await _IFeatures_Options.SaveFeatures_Options(model);
				var Result = await _IFeatures_Options.SaveFeatures_OptionsForProduction(model);
				if (Result != null)
				{
					if (Result.StatusText == "Success" && Result.StatusCode == HttpStatusCode.OK)
					{
				...
				return RedirectToAction(nameof(FeaturesOptionsProduction));
		...
		[HttpPost]
		public async Task<IActionResult> FeaturesOptionsAccounts(Features_OptionsModel model, string Type = "Accounts")
		{
			try
			{
				model.CreatedBy = Convert.ToInt32(HttpContext.Session.GetString("UID"));
				...
				return RedirectToAction(nameof(FeaturesOptionsAccounts));
		...
		public async Task<ActionResult> FeaturesOptionsPurchaseBill(int ID, int YC, string Mode, string Type)
		{
			var MainModel = new Features_OptionsModel();
			int ActualEntryBy = Convert.ToInt32(HttpContext.Session.GetString("UID"));
			string MachineName = HttpContext.Session.GetString("ClientMachineName");
		...
		[HttpPost]
		public async Task<IActionResult> FeaturesOptionsPurchaseBill(Features_OptionsModel model, string Type = "SaleOrderDetail")
		{
			try
			{
				model.CreatedBy = Convert.ToInt32(HttpContext.Session.GetString("UID"));
				...
				return RedirectToAction(nameof(FeaturesOptionsPurchaseBill));
		...
		public async Task<ActionResult> FeaturesOptionsPurchaseOrder(int ID, int YC, string Mode, string Type)
		{
			var MainModel = new Features_OptionsModel();
			int ActualEntryBy = Convert.ToInt32(HttpContext.Session.GetString("UID"));
			string MachineName = HttpContext.Session.GetString("ClientMachineName");
		...
		[HttpPost]
		public async Task<IActionResult> FeaturesOptionsPurchaseOrder(Features_OptionsModel model, string Type = "SaleOrderDetail")
		{
			try
			{
				model.CreatedBy = Convert.ToInt32(HttpContext.Session.GetString("UID"));
		...
		public async Task<ActionResult> FeaturesOptionsIssueeChallan(int ID, int YC, string Mode, string Type)
		{
			var MainModel = new Features_OptionsModel();
			int ActualEntryBy = Convert.ToInt32(HttpContext.Session.GetString("UID"));
			string MachineName = HttpContext.Session.GetString("ClientMachineName");
			string IPAddress = HttpContext.Session.GetString("ClientIP");
			Type = "IssueChallanDetail";
			var rights = await _IFeatures_Options.GetFormRights(ActualEntryBy);
			if (rights?.Result == null || rights.Result.Tables.Count == 0 || rights.Result.Tables[0].Rows.Count == 0)
			{
				return RedirectToAction("Dashboard", "Home");
		...
		[HttpPost]
		public async Task<IActionResult> FeaturesOptionsIssueeChallan(Features_OptionsModel model, string Type = "SaleOrderDetail")
		{
			try
			{
				model.CreatedBy = Convert.ToInt32(HttpContext.Session.GetString("UID"));
				...
				return RedirectToAction(nameof(FeaturesOptionsIssueeChallan));
