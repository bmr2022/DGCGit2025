                    ...
                    if (obj.AdjAdjustmentDetailGrid != null) {
                        $.each(obj.AdjAdjustmentDetailGrid, function (index, val) {
                            html += '<tr id="DisplayAdjustmntRow-' + index + '">' +
                                ...
                                '<td><input id="AdjAgnstPendAmt_' + index + '" value=' + val.AdjAgnstPendAmt + ' readonly style="width:50px;background: none;border: none;"></td>' +
                                ...
                                '<td><input class="adjstedamt" id="AdjAgnstAdjstedAmt_' + index + '" value=' + val.AdjAgnstAdjstedAmt + ' readonly style="width:50px;background: none;border: none;"></td>' +
