...
function parseDateToFormat(inputDate) {
    ...
    if (isNaN(month)) {
        ...
        month = monthAbbrToNum[month.slice(0, 3)];
    }
...
//        /\b(\d{1,2})[-/](\d{1,2})[-/](\d{4})[ ](\d{1,2}):(\d{2}):(\d{2})[ ]?(AM|PM|am|pm)?\b/,
//        /\b(\d{1,2})\/([A-Za-z]{3})\/(\d{4})\b/,     // dd/MMM/yyyy
//        /\b(\d{1,2})\/(\d{1,2})\/(\d{4})\b/          // mm/dd/yyyy (NEW)
//    ];
...
//            } else if (format === dateFormats[5]) {
//                [, day, month, year] = match; // dd-MMM-yyyy
//            } else if (format === dateFormats[8]) { // NEW: mm/dd/yyyy
//                [, month, day, year] = match;
//            }
//            break;
//        }
...
//    if (month && month.length === 3 && isNaN(month)) {
//        const monthAbbreviations = {
//            Jan: '01', Feb: '02', Mar: '03',
//            Apr: '04', May: '05', Jun: '06',
//            Jul: '07', Aug: '08', Sep: '09',
...
//new sumu
//function parseDateToFormat(inputDate) {
//    if (!inputDate) return new Date(); // Fallback if empty
...
//            } else if (format === dateFormats[2]) {
//                [, day, month, year] = match; // dd/Mon/yyyy
//                month = new Date(`${month} 1, 2000`).getMonth() + 1; // Convert "Apr" → 4
//            } else if (format === dateFormats[3]) {
//                [, month, day, year] = match; // MM/dd/yy
//                year = `20${year}`;
//            } else if (format === dateFormats[4]) {
...
//    // Return a Date object (month is 0-indexed in JavaScript)
