    ...
    if (RowCount >= 1 && ColumnCount > 1 && isExpense) {
        ...
        if ($('#TxType').val() == "TAX") {
            ...
            $.ajax({
                ...
                if ( $('title').text().indexOf('Purchase Rejection') == 0 || ($('title').text().indexOf('Purchase Bill') == 0 && $('title').text().indexOf('Direct') != 0) || $('title').text().indexOf('SaleInvoice') == 0 || $('title').text().indexOf('Credit Note ') == 0) {
