    ...
    $.ajax({
        ...
        success: function (data, status, error) {
            ...
            commonElements.forEach(function (element) {
                ...
                if (optSave == true) {
                    $('#' + element).css({ "pointer-events": "", "color": "white" });
                }
                else {
                    $('#' + element).removeAttr("style").css({ "pointer-events": "none", "color": "gray !important", "background-color": "#d3d3d3 !important" });
                }
                if (optView == true) {
                    $('.' + element).css({ "pointer-events": "", "color": "white" });
                }
...
$('.btnClearTax').click(function (e) {
    ...
    $.ajax({
        ...
        success: function (data, status, xhr) {
            ...
            if ($('title').text().indexOf('Direct Purchase Bill') == 0 || ($('title').text().indexOf('Purchase Bill') == 0 && $('title').text().indexOf('Direct') != 0) || $('title').text().indexOf('SaleInvoice') == 0 || $('title').text().indexOf('Purchase Rejection') == 0) {
                GetDbCrDetail();
            }
        }
    }).done(function (data) {
