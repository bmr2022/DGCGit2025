...
function parseDateToFormat(input) {
    if (!input) return "";
    ...
    // Try to detect whether format is MM/DD/YYYY or DD/MM/YYYY
    if (parseInt(part1) > 12) {
        ...
        // Ambiguous: assume MM/DD/YYYY by default
        day = part2;
        month = part1;
    }
    ...
    $.ajax({
        ...
        success: function (resp, status, error) {
            if (resp.trim() == "") {
                ...
                //    }
                //}
                $('#divTaxGrid tr').each(function (index) {
                    if (index === 0) return; 
                    const $row = $(this);
