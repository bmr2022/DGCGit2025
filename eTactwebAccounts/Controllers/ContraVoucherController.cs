...
namespace eTactwebAccounts.Controllers
{
      public class ContraVoucherController : Controller
    {
        ...
        public ContraVoucherController(ILogger<ContraVoucherController> logger, IDataLogic iDataLogic, IContraVoucher IContraVoucher, EncryptDecrypt encryptDecrypt, IWebHostEnvironment iWebHostEnvironment, IConfiguration iconfiguration)
        {
            _logger = logger;
