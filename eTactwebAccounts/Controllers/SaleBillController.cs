...
namespace eTactWeb.Controllers
{
    public class SaleBillController : Controller
    {
        ...
        private static DataTable GetDetailTable(IList<SaleBillDetail> DetailList)
        {
            ...
            DTSSGrid.Columns.Add("AdviceEntryId", typeof(int));
            DTSSGrid.Columns.Add("AdviceYearCode", typeof(int));
            DTSSGrid.Columns.Add("AdviceDate", typeof(string));
            ...
            foreach (var Item in DetailList)
            {
                ...
                DTSSGrid.Rows.Add(
                    ...
                    Item.SchNo ?? "",
                    Item.Schdate == null ? string.Empty : (Item.Schdate.Split(" ")[0]),
                    Item.SaleSchYearCode,
                    Item.SOAmendNo ?? string.Empty,
                    Item.SchAmendDate == null ? string.Empty : (Item.SchAmendDate.Split(" ")[0]),
                    Item.ItemCode,
                    ...
                    Item.AdviseEntryId,
                    Item.AdviceYearCode,
                    Item.AdviseDate == null ? string.Empty : (Item.AdviseDate.Split(" ")[0]),
                    Item.ProcessId,
                    ...
                    Item.AgaisntProdPlanDate == null ? string.Empty : (Item.AgaisntProdPlanDate.Split(" ")[0]),
                    Item.GSTPer,
